...
from backend.app.controllers import project_controller, stage_controller, resource_controller, history_controller, user_controller
...
def run_migrations():
    with engine.connect() as conn:
        try:
            ...
            conn.execute(text("ALTER TABLE users ADD COLUMN IF NOT EXISTS can_add_users INTEGER DEFAULT 0"))
